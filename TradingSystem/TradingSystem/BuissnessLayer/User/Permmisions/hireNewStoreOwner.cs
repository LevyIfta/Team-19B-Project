...
namespace TradingSystem.BuissnessLayer.User.Permmisions
{
    public class hireNewStoreOwner : aPermission 
    {
        ...
        {
            aPermissionData me = DataAccess.getPremmisionHNO(owner, this.store);
            if (me == null)
                me = new hireNewStoreOwnerPermissionData(store, sponser);
            if (next == null)
        ...
        {
            return PersmissionsTypes.HireNewStoreOwner;
        }
    }
}
