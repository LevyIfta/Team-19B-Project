...
namespace Tests
{
    ...
    */
    ...
    public class PolicyTests
    {
        ...
        {
            // init usernames and passes
            string storeName1 = "store_ProductAgePolicyGood";//, storeName2 = "store2_adminTest";
            string ownerUsername = "owner_0001", ownerPass = "123Xx123";
            string buyerUsername = "noOne_0001", newPass = "123Xx321";
            //string adminUSername = "admin_test", adminPass = "123Xx123"; //
            // init products info
            string p1_name = "Bamba", p1_man = "Osem", p1_cat = "Food";
            //string p2_name = "Jeans", p2_man = "Castro", p2_cat = "clothing";
            ...
            Assert.AreEqual(receipts1[0], "true", "couldn't manage to buy bamba with age = 18");
        ...
        {// init usernames and passes
            string storeName1 = "store_ProductAgePolicyBad";//, storeName2 = "store2_adminTest";
            string ownerUsername = "owner_0002", ownerPass = "123Xx123";
            string buyerUsername = "noOne_0002", newPass = "123Xx321";
            //string adminUSername = "admin_test", adminPass = "123Xx123"; //
            // init products info
            string p1_name = "Bamba", p1_man = "Osem", p1_cat = "Food";
            //string p2_name = "Jeans", p2_man = "Castro", p2_cat = "clothing";
